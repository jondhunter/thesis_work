...
model.add(Dense(units=units,activation='tanh',name='hidden1'))
model.add(Dense(units=units,activation='tanh',name='hidden2'))
model.add(Dense(units=units,activation='tanh',name='hidden3'))
model.add(Dense(units=units,activation='tanh',name='hidden4'))
model.add(Dense(units=units,activation='tanh',name='hidden5'))
...
model.save('2018_200k_mm_PCA/')
score = model.evaluate(x_test, y_test, verbose=1)
accuracy=score[1]
f=open("2018_200k_mm_PCA.txt","w+")
