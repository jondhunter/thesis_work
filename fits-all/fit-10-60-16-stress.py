...
with open("fit_times-pi-10-{}-{}-stress.csv".format(i,b), "w") as my_empty_csv:
	time_model_fits_to_csv(i,b,'2018_200k_mm_PCA_dynamic/','2018-testing-mm-PCA10-random-timestamp.csv',"fit_times-pi-10-{}-{}-stress.csv".format(i,b))
