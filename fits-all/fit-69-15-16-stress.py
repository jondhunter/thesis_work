...
with open("fit-times-pi-69-{}-{}-stress.csv".format(i,b), "w") as my_empty_csv:
	time_model_fits_to_csv(i,b,'2018_200k_mmscaled_dynamic/','2018-testing-mmscaled-random-timestamp.csv',"fit-times-pi-69-{}-{}-stress.csv".format(i,b))
