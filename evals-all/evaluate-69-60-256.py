...
with open("evaluate-times-pi-69-{}-{}.csv".format(i,b), "w") as my_empty_csv:
	time_model_evaluates_to_csv(i,b,'2018_200k_mmscaled_dynamic/','2018-testing-mmscaled-random-timestamp.csv',"evaluate-times-pi-69-{}-{}.csv".format(i,b))
