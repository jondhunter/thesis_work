...
# df = pd.read_csv('/home/jhunter/dl-testing/TrainingMLCVE/finalpaperCSVs/2017-training-100k-DP-mmscaled.pcap_ISCX.csv')
# df = pd.read_csv('/home/jhunter/dl-testing/TrainingMLCVE/finalpaperCSVs/2017-training-hulk-DP-mmscaled.pcap_ISCX.csv')
# df = pd.read_csv('/home/jhunter/dl-testing/TrainingMLCVE/finalpaperCSVs/2017-training-ddos-DP-mmscaled.pcap_ISCX.csv')
# df = pd.read_csv('/home/jhunter/dl-testing/TrainingMLCVE/finalpaperCSVs/2017-training-100k-noDP-mmscaled.pcap_ISCX.csv')
# df = pd.read_csv('/home/jhunter/dl-testing/TrainingMLCVE/finalpaperCSVs/2017-training-hulk-noDP-mmscaled.pcap_ISCX.csv')
# df = pd.read_csv('/home/jhunter/dl-testing/TrainingMLCVE/finalpaperCSVs/2017-training-ddos-noDP-mmscaled.pcap_ISCX.csv')
...
# f = open("2017-100k-DP-mmscaled-bestarch.txt", "w+")
# f = open("2017-hulk-DP-mmscaled-bestarch.txt", "w+")
# f = open("2017-ddos-DP-mmscaled-bestarch.txt", "w+")
# f = open("2017-100k-noDP-mmscaled-bestarch.txt", "w+")
# f = open("2017-hulk-noDP-mmscaled-bestarch.txt", "w+")
# f = open("2017-ddos-noDP-mmscaled-bestarch.txt", "w+")
f = open("2018-training-mmscaled-bestarch.txt")
